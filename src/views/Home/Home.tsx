import { projectionChart, revenueChart, salesChart, topSellingProducts } from '../../data/data';
					...
					<Grid container size={12} spacing={3.5}>
						...
						<Grid>
							<CardWithTitle 
								...
								sx={{ height: "100%" }}
							>
								<Chart options={projectionChart.options as ApexOptions} series={projectionChart.series} type="bar" height={"170px"} />
						...
						<Grid size={9}>
							<CardWithTitle 
								...
								sx={{ height: "100%" }}
							>
								<Chart options={revenueChart.options as ApexOptions} series={revenueChart.series} type="line" height={"230px"} />
								{/* <Box display={"flex"} alignItems={"center"} gap={2} maxHeight={"100%"}>
						...
						<Grid size={3}>
							...
							>							
								<Box display={"flex"} flexDirection={"column"} alignItems={"center"} gap={2} maxHeight={"100%"}>
									<Chart options={salesChart.options as ApexOptions} series={salesChart.series} type="donut" height={"400px"} />
